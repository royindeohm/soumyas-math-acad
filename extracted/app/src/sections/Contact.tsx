        ...
        <div className="flex flex-col md:flex-row gap-16">
          ...
          >
            <form
              ...
              className="bg-[#f8fafc] rounded-2xl p-8 md:p-10 border border-[#e2e8f0]"
            >
              <h3 className="font-['Poppins'] font-semibold text-[22px] text-[#1a1a2e] mb-6">
                Send an Enquiry
              </h3>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <label
                    htmlFor="name"
                    className="block font-['Inter'] font-medium text-[14px] text-[#4a5568] mb-2"
                  >
                    Student Name
                  </label>
                  <input
                    ...
                    className="w-full bg-white border border-[#e2e8f0] rounded-xl px-5 py-4 font-['Inter'] text-[16px] text-[#1a1a2e] placeholder:text-[#94a3b8] focus:border-[#6366f1] focus:shadow-[0_0_0_3px_rgba(99,102,241,0.1)] focus:outline-none transition-all"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-[#e2e8f0] rounded-xl px-5 py-4 font-['Inter'] text-[16px] text-[#1a1a2e] focus:border-[#6366f1] focus:shadow-[0_0_0_3px_rgba(99,102,241,0.1)] focus:outline-none transition-all appearance-none cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white border border-[#e2e8f0] rounded-xl px-5 py-4 font-['Inter'] text-[16px] text-[#1a1a2e] placeholder:text-[#94a3b8] focus:border-[#6366f1] focus:shadow-[0_0_0_3px_rgba(99,102,241,0.1)] focus:outline-none transition-all resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#6366f1] text-white py-4 rounded-xl font-['Inter'] font-semibold text-[16px] hover:bg-[#4f46e5] transition-colors mt-2"
                >
                  Send Enquiry
                </button>
              </div>
