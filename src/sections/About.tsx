        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              {credentials.map((cred, i) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-[#e6fcfd] flex items-center justify-center flex-shrink-0">
                    <cred.icon size={20} className="text-[#1d6fc4]" />
                  </div>
                  <span className="font-['Inter'] font-medium text-[16px] text-[#0f2b5c]">
                    {cred.text}
                  </span>
                </div>
              ))}
          ...
          >
            <div className="relative group max-w-[420px] w-full">
              ...
              <div className="absolute -inset-2 rounded-2xl bg-gradient-to-tr from-[#0f2b5c] to-[#00c4e8] opacity-20 blur-lg group-hover:opacity-30 transition duration-500" />
              <div className="absolute inset-0 rounded-2xl border-2 border-[#1d6fc4]/20 translate-x-3 translate-y-3 -z-10" />
              
              <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(15,43,92,0.08)] border border-[#e2e8f0] bg-white aspect-[4/5]">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#f8fafc] to-[#e6fcfd] flex flex-col items-center justify-center p-6 text-center -z-10">
                  <div className="w-20 h-20 rounded-full bg-[#e6fcfd] flex items-center justify-center text-[#1d6fc4] mb-4 shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                    </svg>
                  </div>
                  <h4 className="font-['Poppins'] font-bold text-lg text-[#0f2b5c]">Soumyadip Biswas</h4>
                  <p className="font-['Inter'] text-sm text-[#1d6fc4] font-medium mt-1">M.Sc Mathematics</p>
                </div>
              </div>
              ...
              <div className="absolute bottom-6 -left-6 bg-white/90 backdrop-blur-md border border-[#e2e8f0] px-5 py-3 rounded-2xl shadow-xl flex items-center gap-3 animate-float-slow">
                <div className="w-8 h-8 rounded-lg bg-[#e6fcfd] flex items-center justify-center text-[#1d6fc4]">
                  <GraduationCap size={18} />
                </div>
                <div>
                  <p className="font-['Poppins'] font-bold text-[13px] text-[#0f2b5c] leading-tight">M.Sc Math</p>
