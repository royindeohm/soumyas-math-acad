  ...
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-center bg-white overflow-hidden pt-28 pb-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none" aria-hidden="true">
        <div className="absolute top-[20%] left-[10%] text-[20px] md:text-[24px] font-semibold text-[#1d6fc4]/10 animate-float-slow">∫ dy = y + C</div>
        <div className="absolute top-[60%] left-[8%] text-[24px] md:text-[28px] font-bold text-[#0f2b5c]/10 animate-float-delayed">∑ x_i</div>
        <div className="absolute top-[15%] right-[12%] text-[28px] md:text-[32px] font-bold text-[#1d6fc4]/15 animate-float-reverse">π ≈ 3.14159</div>
        <div className="absolute top-[50%] right-[15%] text-[22px] md:text-[26px] font-semibold text-[#0f2b5c]/10 animate-float-slow">f'(x) = lim...</div>
        <div className="absolute bottom-[10%] left-[25%] text-[18px] md:text-[22px] font-semibold text-[#0f2b5c]/10 animate-float-delayed">√x² + y²</div>
        <div className="absolute bottom-[20%] right-[30%] text-[26px] md:text-[30px] font-bold text-[#1d6fc4]/10 animate-float-reverse">E = mc²</div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 flex flex-col justify-center">
        <div className="max-w-[650px] text-left">
          {/* Label */}
          <div
            className={`inline-flex items-center gap-2 bg-[#e6fcfd] text-[#1d6fc4] px-4 py-1.5 rounded-full font-semibold text-xs tracking-wider uppercase mb-6 transition-all duration-700 ease-out ${
              loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
            style={{ transitionDelay: '0.2s' }}
          >
            <span className="w-1.5 h-1.5 rounded-full bg-[#00c4e8] animate-pulse"></span>
            M.SC MATHEMATICS · OFFLINE COACHING
          </div>

          {/* Headline */}
          <h1
            className={`heading-1 text-[#0f2b5c] mb-6 transition-all duration-800 ease-out ${
          ...
          >
            Master Mathematics
            <br />
            <span className="text-[#1d6fc4]">with Confidence</span>
          </h1>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#e6fcfd] flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-[#1d6fc4]">
              ...
              <div>
                ...
                <a
                  href="tel:6291210836"
                  className="font-['Poppins'] font-bold text-[18px] text-[#0f2b5c] hover:text-[#1d6fc4] transition-colors"
                >
                  +91 62912 10836
                </a>
              </div>
